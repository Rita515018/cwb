...
plot(x=n35$Time,y=n35$weight,type='o',main="Chicken 35",las=1,lwd=2,xlab="Time",ylab="Weight",col=1)
...
plot(x=n24$Time,y=n24$weight,type='o',main="Chicken 24",las=1,lwd=2,xlab="Time",ylab="Weight",col="orange1")
plot(x=n25$Time,y=n25$weight,type='o',main="Chicken 25",las=1,lwd=2,xlab="Time",ylab="Weight",col=7)
plot(x=n26$Time,y=n26$weight,type='o',main="Chicken 26",las=1,lwd=2,xlab="Time",ylab="Weight",col=5)
d2=subset(ChickWeight, Diet==2)
plot(x=d2$Time,y=d2$weight,type='p',main="Diet 2",las=1,xlab="Time",ylab="Weight",col=1)
