...
plot(jul$測站氣壓,type="o", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/07", axes=TRUE)
plot(jul$測站氣壓,type="s", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/07", axes=TRUE)
plot(jul$測站氣壓,type="S", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/07", axes=TRUE)
...
plot(aug$測站氣壓,type="o", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/08", axes=TRUE)
plot(aug$測站氣壓,type="s", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/08", axes=TRUE)
plot(aug$測站氣壓,type="S", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/08", axes=TRUE)

plot(sep$測站氣壓,type="b", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/09", axes=TRUE)
plot(sep$測站氣壓,type="o", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/09", axes=TRUE)
plot(sep$測站氣壓,type="s", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/09", axes=TRUE)
plot(sep$測站氣壓,type="S", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/09", axes=TRUE)

plot(oct$測站氣壓,type="b", pch=16, col="black",las=1,xlab="日期" ,
      ylab="大氣壓",main="2017/10", axes=TRUE)
plot(oct$測站氣壓,type="o", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/10", axes=TRUE)

plot(nov$測站氣壓,type="b", pch=16, col="black",las=1,xlab="日期" ,
       ylab="大氣壓",main="2017/11", axes=TRUE)
plot(nov$測站氣壓,type="o", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/11", axes=TRUE)
plot(nov$測站氣壓,type="s", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/11", axes=TRUE)
plot(nov$測站氣壓,type="S", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/11", axes=TRUE)

plot(dec$測站氣壓,type="b", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/12", axes=TRUE)
plot(dec$測站氣壓,type="o", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/12", axes=TRUE)
plot(dec$測站氣壓,type="s", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/12", axes=TRUE)
plot(dec$測站氣壓,type="S", pch=16, col="black",las=1,xlab="日期" ,
     ylab="大氣壓",main="2017/12", axes=TRUE)
